  ...
  return (
    <div className="message request-user-input-message">
      <div
        ...
        role="group"
        aria-label={t("requestUserInput.userInputRequested")}
      >
        <div className="request-user-input-header">
          <div className="request-user-input-title">{t("requestUserInput.inputRequested")}</div>
          {totalRequests > 1 ? (
            <div className="request-user-input-queue">
              {t("requestUserInput.requestNOfTotal", { n: 1, total: totalRequests })}
            </div>
          ) : null}
        </div>
        <div className="request-user-input-body">
          {questions.length ? (
            ...
            <div className="request-user-input-empty">
              {t("requestUserInput.noQuestionsProvided")}
            </div>
          )}
        </div>
