    ...
    <div className="launch-script-menu" ref={popoverRef}>
      <div className="launch-script-buttons">
        <button
          ...
          aria-label={hasLaunchScript ? t("launchScript.runLaunchScript") : t("launchScript.setLaunchScript")}
          title={hasLaunchScript ? t("launchScript.runLaunchScript") : t("launchScript.setLaunchScript")}
        >
      ...
      {editorOpen && (
        <div className="launch-script-popover popover-surface" role="dialog">
          <div className="launch-script-title">{t("launchScript.launchScript")}</div>
          <textarea
          ...
          <div className="launch-script-actions">
            ...
            <button
              ...
              data-tauri-drag-region="false"
            >
              {isSaving ? t("launchScript.saving") : t("common.save")}
            </button>
          </div>
          {showNew && newEditorOpen && onNewDraftChange && onNewDraftIconChange && onCreateNew && (
            <div className="launch-script-new">
              <div className="launch-script-title">{t("launchScript.newLaunchScript")}</div>
              ...
              <div className="launch-script-actions">
                ...
                <button
                  ...
                  data-tauri-drag-region="false"
                >
                  {isSaving ? t("launchScript.saving") : t("common.create")}
                </button>
              </div>
            </div>
          )}
