    ...
    <div className="workspace-group">
      {showHeader && (
        <div
          ...
          aria-label={isToggleable ? (isCollapsed ? t("workspaceGroup.expandGroup") : t("workspaceGroup.collapseGroup")) : undefined}
        ...
        >
          ...
          {isToggleable && (
            <button
              ...
              aria-label={isCollapsed ? t("workspaceGroup.expandGroup") : t("workspaceGroup.collapseGroup")}
